...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-a7d0502c","hasScoped":false,"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./components/area-select/select/index.vue
...
}},[_c('span',{ref:"trigger",staticClass:"area-selected-trigger",on:{"click":_vm.handleTriggerClick}},[_vm._v(_vm._s(_vm.label ? _vm.label : _vm.placeholder))]),_vm._v(" "),_c('i',{class:[_vm.icon, { 'active': _vm.shown }],on:{"click":function($event){$event.stopPropagation();return _vm.handleTriggerClick($event)}}}),_vm._v(" "),_c('transition',{attrs:{"name":"area-zoom-in-top"},on:{"before-enter":_vm.handleListEnter}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.shown),expression:"shown"}],ref:"wrap",staticClass:"area-selectable-list-wrap",style:({top: _vm.top + 'px'})},[_c('ul',{staticClass:"area-selectable-list"},[_vm._t("default")],2)])])],1)}
var staticRenderFns = []
...
}],attrs:{"value":_vm.value},on:{"click":function($event){$event.stopPropagation();return _vm.selectOptionClick($event)},"mouseleave":_vm.leaveItem,"mouseenter":_vm.hoverItem}},[_vm._v("\n    "+_vm._s(_vm.label)+"\n")])}
...
var option_normalizeComponent = __webpack_require__(6)
/* script */
...
/* harmony default export */ var area_select = ({
    ...
    watch: {
        ...
        value: function value(val) {
            ...
            if (!this.isSetDefault && Object(utils["c" /* isArray */])(val) && val.length && val.length !== this.level + 1) {
    ...
    created: function created() {
        if (Object(utils["c" /* isArray */])(this.value) && this.value.length === this.level + 1) {
            this.beforeSetDefault();
            this.setDefaultValue();
        }

        if (Object(utils["c" /* isArray */])(this.value) && this.value.length && this.value.length !== this.level + 1) {
            Object(utils["a" /* assert */])(false, '\u8BBE\u7F6E\u7684\u9ED8\u8BA4\u503C\u548C level \u503C\u4E0D\u5339\u914D');
        }
    }
});
...
var area_select_normalizeComponent = __webpack_require__(6)
/* script */
...
// CONCATENATED MODULE: ./components/area-select/index.js


components_area_select.install = function (Vue) {
    Vue.component(components_area_select.name, components_area_select);
};

/* harmony default export */ var components_area_select_0 = __webpack_exports__["default"] = (components_area_select);
...
// module
exports.push([module.i, ".area-select-wrap .area-select{margin-left:10px}.area-select-wrap .area-select-empty{padding:4px 0;margin:0;text-align:center;color:#999;font-size:14px}", ""]);
