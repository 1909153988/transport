      ...
      <div class="borderdiv">
              ...
              <el-row :gutter="20" style="margin-left: 0px">
                <el-col :span="24" style="margin-right: 1.4%">
                  <el-form-item prop="monitorTime">
                    <el-checkbox v-model="checked">保存为常用路线</el-checkbox>
                  </el-form-item>
                </el-col>
              </el-row>
            </div></el-col
        ...
        <div class="info">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8"
              ><div class="grid-content bg-purple">
                <el-form-item style="font-weight:bold"> 总运费：XXXX元 </el-form-item>
              </div></el-col
            >
          </el-row>
          ...
          <div class="info">
            ...
            <el-row :gutter="20">
              <el-col :span="12"
                ><div class="grid-content bg-purple">
                  <el-form-item label="车型要求" prop="monitorTime">
              ...
              <el-col :span="12"
                ><div class="grid-content bg-purple">
                  <el-form-item label="车长要求" prop="monitorTime">
                    <el-select v-model="value" placeholder="不限" size="mini">
                      <el-option
                        v-for="item in options"
                        :key="item.value"
           ...
           <el-form-item label=" ">
          <el-button type="primary" @click="submitForm('form')" plain>保存</el-button>
           <el-button type="info" @click="gopaiche()" plain>保存并调度派车</el-button>
            <el-button @click="submitForm('form')" plain>取消</el-button>
        </el-form-item>
          </div>
        </div>
      </div>
