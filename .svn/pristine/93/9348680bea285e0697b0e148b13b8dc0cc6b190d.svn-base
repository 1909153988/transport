...
<script>
  import {addline, getUserCompany, linelist, selectlinehuowu} from "@/api/waybill/waybilllist";
      ...
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            const valueClientUserCompany = this.valueClientUserCompany;
            if (valueClientUserCompany == undefined || valueClientUserCompany == null || valueClientUserCompany == "") {
              this.$message.error("请选择托运人");
              return;
            }
            ...
            this.form.userId = this.valueClientUserCompany;
            //新建常发路线
            addline(this.form).then((response) => {
              ...
              // console.log(response);
              // // this.tableData=response.rows;
              // // this.ifInvoiceSelect=response.rows;
              // console.log( this.ifInvoiceSelect=response.rows);
            });
          } else {
